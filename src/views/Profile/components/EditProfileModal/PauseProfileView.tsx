...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@kaco/adao_ui';
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% KAC', { cost: getBalanceNumber(numberCakeToReactivate) })}
      </Text>
