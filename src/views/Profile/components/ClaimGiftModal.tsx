...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from '@kaco/adao_ui';
  ...
  return (
    <Modal title={t('Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        ...
        <Text as="p">{t('To make it up to you, we’ll refund you the full 4 KAC it cost to make your bunny.')}</Text>
        <Text as="p" mb="8px">
