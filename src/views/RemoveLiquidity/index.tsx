...
import { Button, Text, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@kaco/adao_ui';
        ...
        <CardBody>
          ...
          {!showDetailed && (
            <>
              ...
              <AutoColumn gap="10px">
                <Text bold color="secondary" fontSize="14px" mb="16px" textTransform="uppercase">
                  {t('You will receive')}
                </Text>
                <SolidCard>
