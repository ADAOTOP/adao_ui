...
import { Button, Skeleton } from '@kaco/adao_ui';
...
import { ActionContainer, ActionTitles, ActionContent, ActionTitlesTitle, ActionTitlesBalance } from './styles';
