...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@kaco/adao_ui';
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in KAC prizes this round', { cakePrizeInUsd: cakePriceBusdAsString });
