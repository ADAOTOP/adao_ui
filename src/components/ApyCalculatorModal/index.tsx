...
import { Modal, Text, LinkExternal, Flex, Box } from '@kaco/adao_ui';
        ...
        <Box mb="28px" maxWidth="280px" p="4px">
          <BulletList>
            ...
            {isFarm && (
              <li>
                <Text fontSize="12px" textAlign="center" color="textSubtle" display="inline">
                  {t('LP rewards: 0.1875% trading fees, distributed proportionally among LP token holders.')}
                </Text>
              </li>
            )}
            <li>
