import { ChainId, CHAINKEY, TradeType } from '../constants';
...
export declare class Trade {
     ...
     */
    static bestTradeExactIn(pairs: Pair[], currencyAmountIn: CurrencyAmount, currencyOut: Currency, { maxNumResults, maxHops }: BestTradeOptions | undefined, currentPairs: Pair[] | undefined, originalAmountIn: CurrencyAmount | undefined, bestTrades: Trade[] | undefined, chainKey: CHAINKEY): Trade[];
    /**
     ...
     * @param bestTrades used in recursion; the current list of best trades
     */
    static bestTradeExactOut(pairs: Pair[], currencyIn: Currency, currencyAmountOut: CurrencyAmount, { maxNumResults, maxHops }: BestTradeOptions | undefined, currentPairs: Pair[] | undefined, originalAmountOut: CurrencyAmount | undefined, bestTrades: Trade[] | undefined, chainKey: CHAINKEY): Trade[];
}
export {};
