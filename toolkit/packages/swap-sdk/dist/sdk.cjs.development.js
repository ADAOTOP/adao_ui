...
(function (CHAINKEY) {
  CHAINKEY["BSC"] = "BSC";
  CHAINKEY["SDN"] = "SDN";
  CHAINKEY["ASTR"] = "ASTR"; // OPTIMISTIC = 'OPTIMISTIC',
  // ARBITRUM = 'ARBITRUM',
  // POLYGON = 'POLYGON',
  // AVALANCH = 'AVALANCH',
  // FANTOM = 'FANTOM',
...
(function (ChainId) {
  ...
  ChainId[ChainId["BSC_TESTNET"] = 87] = "BSC_TESTNET";
  ChainId[ChainId["ASTR_MAINNET"] = 592] = "ASTR_MAINNET";
  ChainId[ChainId["ASTR_TESTNET"] = 81] = "ASTR_TESTNET";
  ChainId[ChainId["SDN_MAINNET"] = 336] = "SDN_MAINNET";
  ChainId[ChainId["SDN_TESTNET"] = 82] = "SDN_TESTNET"; // ARBITRUM_MAINNET = 42161,
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.BSC_MAINNET] = '0xa5e48a6E56e164907263e901B98D9b11CCB46C47', _FACTORY_ADDRESS[exports.ChainId.BSC_TESTNET] = '0xa5e48a6E56e164907263e901B98D9b11CCB46C47', _FACTORY_ADDRESS[exports.ChainId.SDN_MAINNET] = '0xcd8620889c1dA22ED228e6C00182177f9dAd16b7', _FACTORY_ADDRESS[exports.ChainId.SDN_TESTNET] = '0xcd8620889c1dA22ED228e6C00182177f9dAd16b7', _FACTORY_ADDRESS[exports.ChainId.ASTR_MAINNET] = '0x72e86269b919Db5bDbF61cB1DeCfD6d14feC4D7F', _FACTORY_ADDRESS[exports.ChainId.ASTR_TESTNET] = '0x72e86269b919Db5bDbF61cB1DeCfD6d14feC4D7F', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[exports.ChainId.BSC_MAINNET] = '0xf65dd62adf08288b0d787767b8c60ca23df3f25b5a140449a9f9c403ae527424', _INIT_CODE_HASH[exports.ChainId.BSC_TESTNET] = '0xf65dd62adf08288b0d787767b8c60ca23df3f25b5a140449a9f9c403ae527424', _INIT_CODE_HASH[exports.ChainId.SDN_MAINNET] = '0x0558677b74f6dc11ee476ed79ce993579e32b1ae87e818f42c4f9d829c1db12a', _INIT_CODE_HASH[exports.ChainId.SDN_TESTNET] = '0x0558677b74f6dc11ee476ed79ce993579e32b1ae87e818f42c4f9d829c1db12a', _INIT_CODE_HASH[exports.ChainId.ASTR_MAINNET] = '0xee94b86c5982668ed547d5703d5fa42db90a876a4fd1b8915cb2676c4218e822', _INIT_CODE_HASH[exports.ChainId.ASTR_TESTNET] = '0xee94b86c5982668ed547d5703d5fa42db90a876a4fd1b8915cb2676c4218e822', _INIT_CODE_HASH);
...
Currency.ETHER = (_Currency$ETHER = {}, _Currency$ETHER[exports.ChainId.BSC_MAINNET] = /*#__PURE__*/new Currency(18, 'BNB', 'Binance Coin'), _Currency$ETHER[exports.ChainId.BSC_TESTNET] = /*#__PURE__*/new Currency(18, 'BNB', 'Binance Coin'), _Currency$ETHER[exports.ChainId.SDN_MAINNET] = /*#__PURE__*/new Currency(18, 'SDN', 'SDN Token'), _Currency$ETHER[exports.ChainId.SDN_TESTNET] = /*#__PURE__*/new Currency(18, 'SDN', 'SDN Token'), _Currency$ETHER[exports.ChainId.ASTR_MAINNET] = /*#__PURE__*/new Currency(18, 'ASTR', 'ASTR Token'), _Currency$ETHER[exports.ChainId.ASTR_TESTNET] = /*#__PURE__*/new Currency(18, 'ASTR', 'ASTR Token'), _Currency$ETHER);
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.ASTR_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.ASTR_MAINNET, '0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720', 18, 'WASTR', 'Wrapped ASTR'), _WETH[exports.ChainId.ASTR_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.ASTR_TESTNET, '0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720', 18, 'WASTR', 'Wrapped ASTR'), _WETH[exports.ChainId.SDN_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.SDN_MAINNET, '0x0f933Dc137D21cA519ae4C7E93f87a4C8EF365Ef', 18, 'WSDN', 'Wrapped SDN'), _WETH[exports.ChainId.SDN_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.SDN_TESTNET, '0x321F318e7C276c93Cf3094fd3a9d7c4362fd19FB', 18, 'WSDN', 'Wrapped SDN'), _WETH[exports.ChainId.BSC_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.BSC_MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.BSC_TESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, chainId) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, chainId), 18, 'Kaco-LP', 'Kaco LPs');
...
var Route = /*#__PURE__*/function () {
  function Route(chainId, pairs, input, output) {
    !(pairs.length > 0) ?  invariant(false, 'PAIRS')  : void 0;
    !pairs.every(function (pair) {
      return pair.chainId === pairs[0].chainId;
    }) ?  invariant(false, 'CHAIN_IDS')  : void 0;
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER[chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER[chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, chainId) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER[chainId] ? CurrencyAmount.ether(amounts[0].raw, chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER[chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, chainId) : amounts[amounts.length - 1];
  ...
  currentPairs, originalAmountIn, bestTrades, chainKey) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route(chainId, [].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT, chainId), maxNumResults, tradeComparator);
        ...
        Trade.bestTradeExactIn(pairsExcludingThisPair, amountOut, currencyOut, {
          ...
          maxHops: maxHops - 1
        }, [].concat(currentPairs, [pair]), originalAmountIn, bestTrades, chainKey);
      }
    }
  ...
  currentPairs, originalAmountOut, bestTrades, chainKey) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route(chainId, [pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, exports.TradeType.EXACT_OUTPUT, chainId), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
        ...
        Trade.bestTradeExactOut(pairsExcludingThisPair, currencyIn, amountIn, {
          maxNumResults: maxNumResults,
          maxHops: maxHops - 1
        }, [pair].concat(currentPairs), originalAmountOut, bestTrades, chainKey);
      }
    }
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options, chainId) {
    var etherIn = trade.inputAmount.currency === ETHER[chainId];
    var etherOut = trade.outputAmount.currency === ETHER[chainId]; // the router does not support both ether in and out
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, chainId, provider) {
    try {
