...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.BSC_MAINNET] = '0xa5e48a6E56e164907263e901B98D9b11CCB46C47', _FACTORY_ADDRESS[ChainId.BSC_TESTNET] = '0xa5e48a6E56e164907263e901B98D9b11CCB46C47', _FACTORY_ADDRESS[ChainId.SDN_MAINNET] = '0xcd8620889c1dA22ED228e6C00182177f9dAd16b7', _FACTORY_ADDRESS[ChainId.SDN_TESTNET] = '0xcd8620889c1dA22ED228e6C00182177f9dAd16b7', _FACTORY_ADDRESS[ChainId.ASTR_MAINNET] = '0x72e86269b919Db5bDbF61cB1DeCfD6d14feC4D7F', _FACTORY_ADDRESS[ChainId.ASTR_TESTNET] = '0x72e86269b919Db5bDbF61cB1DeCfD6d14feC4D7F', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.BSC_MAINNET] = '0xf65dd62adf08288b0d787767b8c60ca23df3f25b5a140449a9f9c403ae527424', _INIT_CODE_HASH[ChainId.BSC_TESTNET] = '0xf65dd62adf08288b0d787767b8c60ca23df3f25b5a140449a9f9c403ae527424', _INIT_CODE_HASH[ChainId.SDN_MAINNET] = '0x0558677b74f6dc11ee476ed79ce993579e32b1ae87e818f42c4f9d829c1db12a', _INIT_CODE_HASH[ChainId.SDN_TESTNET] = '0x0558677b74f6dc11ee476ed79ce993579e32b1ae87e818f42c4f9d829c1db12a', _INIT_CODE_HASH[ChainId.ASTR_MAINNET] = '0xee94b86c5982668ed547d5703d5fa42db90a876a4fd1b8915cb2676c4218e822', _INIT_CODE_HASH[ChainId.ASTR_TESTNET] = '0xee94b86c5982668ed547d5703d5fa42db90a876a4fd1b8915cb2676c4218e822', _INIT_CODE_HASH);
...
Currency.ETHER = (_Currency$ETHER = {}, _Currency$ETHER[ChainId.BSC_MAINNET] = /*#__PURE__*/new Currency(18, 'BNB', 'Binance Coin'), _Currency$ETHER[ChainId.BSC_TESTNET] = /*#__PURE__*/new Currency(18, 'BNB', 'Binance Coin'), _Currency$ETHER[ChainId.SDN_MAINNET] = /*#__PURE__*/new Currency(18, 'SDN', 'SDN Token'), _Currency$ETHER[ChainId.SDN_TESTNET] = /*#__PURE__*/new Currency(18, 'SDN', 'SDN Token'), _Currency$ETHER[ChainId.ASTR_MAINNET] = /*#__PURE__*/new Currency(18, 'ASTR', 'ASTR Token'), _Currency$ETHER[ChainId.ASTR_TESTNET] = /*#__PURE__*/new Currency(18, 'ASTR', 'ASTR Token'), _Currency$ETHER);
...
var WETH = (_WETH = {}, _WETH[ChainId.ASTR_MAINNET] = /*#__PURE__*/new Token(ChainId.ASTR_MAINNET, '0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720', 18, 'WASTR', 'Wrapped ASTR'), _WETH[ChainId.ASTR_TESTNET] = /*#__PURE__*/new Token(ChainId.ASTR_TESTNET, '0xAeaaf0e2c81Af264101B9129C00F4440cCF0F720', 18, 'WASTR', 'Wrapped ASTR'), _WETH[ChainId.SDN_MAINNET] = /*#__PURE__*/new Token(ChainId.SDN_MAINNET, '0x0f933Dc137D21cA519ae4C7E93f87a4C8EF365Ef', 18, 'WSDN', 'Wrapped SDN'), _WETH[ChainId.SDN_TESTNET] = /*#__PURE__*/new Token(ChainId.SDN_TESTNET, '0x321F318e7C276c93Cf3094fd3a9d7c4362fd19FB', 18, 'WSDN', 'Wrapped SDN'), _WETH[ChainId.BSC_MAINNET] = /*#__PURE__*/new Token(ChainId.BSC_MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(ChainId.BSC_TESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB'), _WETH);
...
var Route = /*#__PURE__*/function () {
  function Route(chainId, pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHER[chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHER[chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, chainId) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHER[chainId] ? CurrencyAmount.ether(amounts[0].raw, chainId) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHER[chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, chainId) : amounts[amounts.length - 1];
  ...
  currentPairs, originalAmountIn, bestTrades, chainKey) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route(chainId, [].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, TradeType.EXACT_INPUT, chainId), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades, chainKey) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route(chainId, [pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, TradeType.EXACT_OUTPUT, chainId), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
